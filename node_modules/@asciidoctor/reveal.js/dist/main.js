...
Opal.modules["asciidoctor-revealjs/converter"] = function(Opal) {/* Generated by Opal 1.7.3 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $truthy = Opal.truthy, $send = Opal.send, $def = Opal.def, $eqeq = Opal.eqeq, $hash2 = Opal.hash2, $to_ary = Opal.to_ary, $not = Opal.not, $rb_plus = Opal.rb_plus, $class_variable_set = Opal.class_variable_set, $class_variable_get = Opal.class_variable_get, $neqeq = Opal.neqeq, $rb_le = Opal.rb_le, $slice = Opal.slice, $rb_lt = Opal.rb_lt, $send2 = Opal.send2, $find_super = Opal.find_super, $eqeqeq = Opal.eqeqeq, $rb_times = Opal.rb_times, $rb_minus = Opal.rb_minus, $rb_ge = Opal.rb_ge, $to_a = Opal.to_a, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$;
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$convert_title_slide', function $$convert_title_slide(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$11(){var self = $$11.$$s == null ? this : $$11.$$s, _buf = nil, bg_image = nil, bg_video = nil, _temple_html_attributeremover1 = nil, _temple_html_attributemerger1 = nil, _slim_codeattributes1 = nil, _slim_codeattributes2 = nil, _slim_codeattributes3 = nil, _slim_codeattributes4 = nil, _slim_codeattributes5 = nil, _slim_codeattributes6 = nil, _slim_codeattributes7 = nil, _slim_codeattributes8 = nil, _slim_codeattributes9 = nil, _slim_codeattributes10 = nil, _slim_codeattributes11 = nil, _slim_codeattributes12 = nil, _slim_codeattributes13 = nil, _slim_codeattributes14 = nil, _slim_codeattributes15 = nil, _title_obj = nil, _slice = nil, preamble = nil;
    ...
    $def(self, '$convert_inline_image', function $$convert_inline_image(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$12(){var self = $$12.$$s == null ? this : $$12.$$s, _buf = nil, _slim_controls1 = nil;
        if (self.type == null) self.type = nil;
        if (self.attributes == null) self.attributes = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 556]), opts)
        };
        _buf = [];
        _slim_controls1 = $send(self, 'html_tag', ["span", $hash2(["class", "style"], {"class": [self.type, self.$role(), (($truthy(self['$option?']("step")) || ($truthy(self['$attr?']("step")))) ? ("fragment") : nil)], "style": ($truthy(self['$attr?']("float")) ? ("float: " + (self.$attr("float"))) : nil)}).$merge(self.$data_attrs(self.attributes))], function $$13(){var self = $$13.$$s == null ? this : $$13.$$s, _slim_controls2 = nil;
    ...
    $def(self, '$convert_literal', function $$convert_literal(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$14(){var self = $$14.$$s == null ? this : $$14.$$s, _buf = nil, _slim_controls1 = nil;
        if (self.attributes == null) self.attributes = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 566]), opts)
        };
        _buf = [];
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.$id(), "class": ["literalblock", self.$role(), (($truthy(self['$option?']("step")) || ($truthy(self['$attr?']("step")))) ? ("fragment") : nil)]}).$merge(self.$data_attrs(self.attributes))], function $$15(){var self = $$15.$$s == null ? this : $$15.$$s, _slim_controls2 = nil, _temple_html_attributeremover1 = nil, _slim_codeattributes1 = nil;
          if (self.document == null) self.document = nil;
    ...
    $def(self, '$convert_notes', function $$convert_notes(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$16(){var self = $$16.$$s == null ? this : $$16.$$s, _buf = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 578]), opts)
        };
        _buf = [];
    ...
    $def(self, '$convert_inline_button', function $$convert_inline_button(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$17(){var self = $$17.$$s == null ? this : $$17.$$s, _buf = nil, _slim_controls1 = nil;
        if (self.attributes == null) self.attributes = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 587]), opts)
        };
        _buf = [];
        _slim_controls1 = $send(self, 'html_tag', ["b", $hash2(["class"], {"class": ["button"]}).$merge(self.$data_attrs(self.attributes))], function $$18(){var self = $$18.$$s == null ? this : $$18.$$s, _slim_controls2 = nil;
    ...
    $def(self, '$convert_embedded', function $$convert_embedded(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$19(){var self = $$19.$$s == null ? this : $$19.$$s, _buf = nil, _slim_codeattributes1 = nil;
        if (self.id == null) self.id = nil;
        if (self.header == null) self.header = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 597]), opts)
        };
        _buf = [];
        ...
        if (!($not(self['$footnotes?']()) || ($truthy(self['$attr?']("nofootnotes"))))) {
          ...
          $send(self.$footnotes(), 'each', [], function $$20(fn){
    ...
    $def(self, '$convert_video', function $$convert_video(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$21(){var self = $$21.$$s == null ? this : $$21.$$s, _buf = nil, no_stretch = nil, $ret_or_1 = nil, width = nil, height = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        ...
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 614]), opts)
        };
        _buf = [];
    ...
    $def(self, '$convert_stretch_nested_elements', function $$convert_stretch_nested_elements(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$23(){var self = $$23.$$s == null ? this : $$23.$$s, _buf = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 668]), opts)
        };
        _buf = [];
    ...
    $def(self, '$convert_floating_title', function $$convert_floating_title(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$24(){var self = $$24.$$s == null ? this : $$24.$$s, _buf = nil, _slim_htag_filter1 = nil, _slim_codeattributes1 = nil, _temple_html_attributeremover1 = nil, _slim_codeattributes2 = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 741]), opts)
        };
        _buf = [];
    ...
    $def(self, '$convert_admonition', function $$convert_admonition(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$25(){var self = $$25.$$s == null ? this : $$25.$$s, _buf = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.attributes == null) self.attributes = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 751]), opts)
        };
        _buf = [];
        if ((($truthy(self['$has_role?']("aside")) || ($truthy(self['$has_role?']("speaker")))) || ($truthy(self['$has_role?']("notes"))))) {
          ...
          _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["admonitionblock", self.$attr("name"), self.$role(), (($truthy(self['$option?']("step")) || ($truthy(self['$attr?']("step")))) ? ("fragment") : nil)]}).$merge(self.$data_attrs(self.attributes))], function $$26(){var self = $$26.$$s == null ? this : $$26.$$s, _slim_controls2 = nil, icon_mapping = nil, _temple_html_attributeremover1 = nil, _slim_codeattributes1 = nil, _slim_codeattributes2 = nil, $ret_or_1 = nil, _slim_codeattributes3 = nil, _slim_codeattributes4 = nil;
            if (self.document == null) self.document = nil;
    ...
    $def(self, '$convert_quote', function $$convert_quote(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$27(){var self = $$27.$$s == null ? this : $$27.$$s, _buf = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.attributes == null) self.attributes = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 777]), opts)
        };
        _buf = [];
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["quoteblock", self.$role(), (($truthy(self['$option?']("step")) || ($truthy(self['$attr?']("step")))) ? ("fragment") : nil)]}).$merge(self.$data_attrs(self.attributes))], function $$28(){var self = $$28.$$s == null ? this : $$28.$$s, _slim_controls2 = nil, attribution = nil, citetitle = nil;
    ...
    $def(self, '$convert_olist', function $$convert_olist(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$29(){var self = $$29.$$s == null ? this : $$29.$$s, _buf = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.style == null) self.style = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 799]), opts)
        };
        _buf = [];
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["olist", self.style, self.$role()]}).$merge(self.$data_attrs(self.attributes))], function $$30(){var self = $$30.$$s == null ? this : $$30.$$s, _slim_controls2 = nil, _temple_html_attributeremover1 = nil, _slim_codeattributes1 = nil, _slim_codeattributes2 = nil, _slim_codeattributes3 = nil;
          if (self.style == null) self.style = nil;
          ...
          _slim_controls2['$<<'](">");
          $send(self.$items(), 'each', [], function $$31(item){var self = $$31.$$s == null ? this : $$31.$$s, _temple_html_attributeremover2 = nil, _slim_codeattributes4 = nil;
    ...
    $def(self, '$convert_inline_footnote', function $$convert_inline_footnote(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$32(){var self = $$32.$$s == null ? this : $$32.$$s, _buf = nil, footnote = nil, index = nil, id = nil, _slim_controls1 = nil, _slim_controls3 = nil;
        if (self.type == null) self.type = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 816]), opts)
        };
        _buf = [];
        ...
        if ($eqeq(self.type, "xref")) {
          ...
          _slim_controls1 = $send(self, 'html_tag', ["sup", $hash2(["class"], {"class": ["footnoteref"]}).$merge(self.$data_attrs(footnote.$attributes()))], function $$33(){var _slim_controls2 = nil;
          ...
          _slim_controls3 = $send(self, 'html_tag', ["sup", $hash2(["id", "class"], {"id": ($truthy(id) ? ("_footnote_" + (id)) : nil), "class": ["footnote"]}).$merge(self.$data_attrs(footnote.$attributes()))], function $$34(){var _slim_controls4 = nil;
    ...
    $def(self, '$convert_preamble', function $$convert_preamble(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$35(){var self = $$35.$$s == null ? this : $$35.$$s, _buf = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 837]), opts)
        };
        _buf = [];
        return (_buf = _buf.$join(""));}, {$$s: self});
    }, -2);
    ...
    $def(self, '$convert_inline_menu', function $$convert_inline_menu(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$36(){var self = $$36.$$s == null ? this : $$36.$$s, _buf = nil, menu = nil, menuitem = nil, submenus = nil, _slim_controls1 = nil, _slim_controls3 = nil, _slim_controls5 = nil;
        if (self.attributes == null) self.attributes = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 847]), opts)
        };
        _buf = [];
        menu = self.$attr("menu");
        ...
        if ($not((submenus = self.$attr("submenus"))['$empty?']())) {
          ...
          _slim_controls1 = $send(self, 'html_tag', ["span", $hash2(["class"], {"class": ["menuseq"]}).$merge(self.$data_attrs(self.attributes))], function $$37(){var _slim_controls2 = nil;
            ...
            _slim_controls2['$<<']("</span>&#160;&#9656;&#32;");
            _slim_controls2['$<<']($send(submenus, 'map', [], function $$38(submenu){
          ...
          _slim_controls3 = $send(self, 'html_tag', ["span", $hash2(["class"], {"class": ["menuseq"]}).$merge(self.$data_attrs(self.attributes))], function $$39(){var _slim_controls4 = nil;
          ...
          _slim_controls5 = $send(self, 'html_tag', ["span", $hash2(["class"], {"class": ["menu"]}).$merge(self.$data_attrs(self.attributes))], function $$40(){var _slim_controls6 = nil;
    ...
    $def(self, '$convert_colist', function $$convert_colist(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$41(){var self = $$41.$$s == null ? this : $$41.$$s, _buf = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.style == null) self.style = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 871]), opts)
        };
        _buf = [];
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["colist", self.style, self.$role()]}).$merge(self.$data_attrs(self.attributes))], function $$42(){var self = $$42.$$s == null ? this : $$42.$$s, _slim_controls2 = nil, font_icons = nil;
          if (self.document == null) self.document = nil;
          ...
          if ($truthy(self.document['$attr?']("icons"))) {
            ...
            $send(self.$items(), 'each_with_index', [], function $$43(item, i){var self = $$43.$$s == null ? this : $$43.$$s, num = nil, _temple_html_attributeremover1 = nil, _slim_codeattributes1 = nil, _slim_codeattributes2 = nil, _slim_codeattributes3 = nil, _slim_codeattributes4 = nil;
              ...
              _slim_controls2['$<<']("<tr");
              _temple_html_attributeremover1 = [];
              _slim_codeattributes1 = ((($truthy(self['$option?']("step")) || ($truthy(self['$has_role?']("step")))) || ($truthy(self['$attr?']("step")))) ? ("fragment") : nil);
              if ($eqeqeq($$('Array'), _slim_codeattributes1)) {
              ...
              if ($truthy(font_icons)) {
                ...
                _slim_controls2['$<<']("<img");
                _slim_codeattributes3 = self.$icon_uri("callouts/" + (num));
                if ($truthy(_slim_codeattributes3)) {
                  if ($eqeq(_slim_codeattributes3, true)) {
                    _slim_controls2['$<<'](" src")
                  } else {
            ...
            _slim_controls2['$<<']("<ol>");
            $send(self.$items(), 'each', [], function $$44(item){var self = $$44.$$s == null ? this : $$44.$$s, _temple_html_attributeremover2 = nil, _slim_codeattributes5 = nil;

              
              if (item == null) item = nil;
              _slim_controls2['$<<']("<li");
              _temple_html_attributeremover2 = [];
              _slim_codeattributes5 = ((($truthy(self['$option?']("step")) || ($truthy(self['$has_role?']("step")))) || ($truthy(self['$attr?']("step")))) ? ("fragment") : nil);
              if ($eqeqeq($$('Array'), _slim_codeattributes5)) {
              ...
              _slim_controls2['$<<']("><p>");
              _slim_controls2['$<<'](item.$text());
              return _slim_controls2['$<<']("</p></li>");}, {$$s: self});
            _slim_controls2['$<<']("</ol>");
          };
          return (_slim_controls2 = _slim_controls2.$join(""));}, {$$s: self});
        _buf['$<<'](_slim_controls1);
    ...
    $def(self, '$convert_paragraph', function $$convert_paragraph(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$45(){var self = $$45.$$s == null ? this : $$45.$$s, _buf = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.attributes == null) self.attributes = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 900]), opts)
        };
        _buf = [];
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["paragraph", self.$role(), (($truthy(self['$option?']("step")) || ($truthy(self['$attr?']("step")))) ? ("fragment") : nil)]}).$merge(self.$data_attrs(self.attributes))], function $$46(){var self = $$46.$$s == null ? this : $$46.$$s, _slim_controls2 = nil;
    ...
    $def(self, '$convert_listing', function $$convert_listing(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$47(){var self = $$47.$$s == null ? this : $$47.$$s, _buf = nil, nowrap = nil, $ret_or_1 = nil, syntax_hl = nil, lang = nil, doc_attrs = nil, css_mode = nil, style = nil, _slim_controls1 = nil;
        if (self.style == null) self.style = nil;
        if (self.attributes == null) self.attributes = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 915]), opts)
        };
        _buf = [];
        ...
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.$id(), "class": ["listingblock", self.$role(), (($truthy(self['$option?']("step")) || ($truthy(self['$attr?']("step")))) ? ("fragment") : nil)]}).$merge(self.$data_attrs($send(self.attributes, 'reject', [], function $$48(key, _){
          
          if (key == null) key = nil;
          if (_ == null) _ = nil;
          return key['$==']("data-id");})))], function $$49(){var self = $$49.$$s == null ? this : $$49.$$s, _slim_controls2 = nil, _temple_html_attributeremover1 = nil, _slim_codeattributes1 = nil, _temple_html_attributeremover2 = nil, _slim_codeattributes2 = nil, _slim_codeattributes3 = nil, _temple_html_attributeremover3 = nil, _slim_codeattributes4 = nil;
          if (self.style == null) self.style = nil;
    ...
    $def(self, '$convert_inline_indexterm', function $$convert_inline_indexterm(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$50(){var self = $$50.$$s == null ? this : $$50.$$s, _buf = nil;
        if (self.type == null) self.type = nil;
        if (self.text == null) self.text = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 948]), opts)
        };
        _buf = [];
    ...
    $def(self, '$convert_table', function $$convert_table(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$51(){var self = $$51.$$s == null ? this : $$51.$$s, _buf = nil, classes = nil, styles = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.attributes == null) self.attributes = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 958]), opts)
        };
        _buf = [];
        ...
        _slim_controls1 = $send(self, 'html_tag', ["table", $hash2(["id", "class", "style"], {"id": self.id, "class": classes, "style": styles}).$merge(self.$data_attrs(self.attributes))], function $$52(){var self = $$52.$$s == null ? this : $$52.$$s, _slim_controls2 = nil;
          ...
          if (!$truthy(self.$attr("rowcount")['$zero?']())) {
            ...
            if ($truthy(self['$option?']("autowidth"))) {
              $send(self.columns, 'each', [], function $$53(){
                return _slim_controls2['$<<']("<col>")})
            } else {
              $send(self.columns, 'each', [], function $$54(col){
            ...
            _slim_controls2['$<<']("</colgroup>");
            $send($send(["head", "foot", "body"], 'select', [], function $$55(tblsec){var self = $$55.$$s == null ? this : $$55.$$s;
              if (self.rows == null) self.rows = nil;

              
              if (tblsec == null) tblsec = nil;
              return self.rows['$[]'](tblsec)['$empty?']()['$!']();}, {$$s: self}), 'each', [], function $$56(tblsec){var self = $$56.$$s == null ? this : $$56.$$s;
              if (self.rows == null) self.rows = nil;
              ...
              _slim_controls2['$<<'](">");
              return $send(self.rows['$[]'](tblsec), 'each', [], function $$57(row){var self = $$57.$$s == null ? this : $$57.$$s;

                
                if (row == null) row = nil;
                _slim_controls2['$<<']("<tr>");
                $send(row, 'each', [], function $$58(cell){var self = $$58.$$s == null ? this : $$58.$$s, cell_content = nil, _slim_controls3 = nil;
                  if (self.document == null) self.document = nil;
                  ...
                  _slim_controls3 = $send(self, 'html_tag', [(($eqeq(tblsec, "head") || ($eqeq(cell.$style(), "header"))) ? ("th") : ("td")), $hash2(["class", "colspan", "rowspan", "style"], {"class": ["tableblock", "halign-" + (cell.$attr("halign")), "valign-" + (cell.$attr("valign"))], "colspan": cell.$colspan(), "rowspan": cell.$rowspan(), "style": ($truthy(self.document['$attr?']("cellbgcolor")) ? ("background-color:" + (self.document.$attr("cellbgcolor")) + ";") : (nil))})], function $$59(){var _slim_controls4 = nil;
                    ...
                    switch (cell.$style()) {
                      ...
                      case "literal":
                        ...
                        break;
                      case "header":
                        $send(cell_content, 'each', [], function $$60(text){
                        ...
                        break;
                      default:
                        $send(cell_content, 'each', [], function $$61(text){
    ...
    $def(self, '$convert_sidebar', function $$convert_sidebar(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$62(){var self = $$62.$$s == null ? this : $$62.$$s, _buf = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.attributes == null) self.attributes = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1012]), opts)
        };
        _buf = [];
        if ((($truthy(self['$has_role?']("aside")) || ($truthy(self['$has_role?']("speaker")))) || ($truthy(self['$has_role?']("notes"))))) {
          ...
          _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["sidebarblock", self.$role(), ((($truthy(self['$option?']("step")) || ($truthy(self['$has_role?']("step")))) || ($truthy(self['$attr?']("step")))) ? ("fragment") : nil)]}).$merge(self.$data_attrs(self.attributes))], function $$63(){var self = $$63.$$s == null ? this : $$63.$$s, _slim_controls2 = nil;
    ...
    $def(self, '$convert_document', function $$convert_document(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$64(){var self = $$64.$$s == null ? this : $$64.$$s, _buf = nil, slides_content = nil, _slim_codeattributes16 = nil, revealjsdir = nil, asset_uri_scheme = nil, cdn_base = nil, icon_href = nil, icon_type = nil, icon_ext = nil, linkcss = nil, _slim_codeattributes19 = nil, iconfont_cdn = nil, _slim_codeattributes20 = nil, font_awesome_version = nil, _slim_codeattributes21 = nil, _slim_codeattributes22 = nil, _slim_codeattributes23 = nil, syntax_hl = nil, _slim_codeattributes24 = nil, customcss = nil, _docinfo = nil, docinfo_content = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1029]), opts)
        };
        _buf = [];
        slides_content = self.$content();
        $send(self, 'content_for', ["slides"], function $$65(){var self = $$65.$$s == null ? this : $$65.$$s, header_docinfo = nil, bg_image = nil, bg_video = nil, _temple_html_attributeremover1 = nil, _temple_html_attributemerger1 = nil, _slim_codeattributes1 = nil, _slim_codeattributes2 = nil, _slim_codeattributes3 = nil, _slim_codeattributes4 = nil, _slim_codeattributes5 = nil, _slim_codeattributes6 = nil, _slim_codeattributes7 = nil, _slim_codeattributes8 = nil, _slim_codeattributes9 = nil, _slim_codeattributes10 = nil, _slim_codeattributes11 = nil, _slim_codeattributes12 = nil, _slim_codeattributes13 = nil, _slim_codeattributes14 = nil, _slim_codeattributes15 = nil, _title_obj = nil, _slice = nil, preamble = nil, footer_docinfo = nil;
          if (self.header == null) self.header = nil;
          if (self.document == null) self.document = nil;
        ...
        $send(["description", "keywords", "author", "copyright"], 'each', [], function $$66(key){var self = $$66.$$s == null ? this : $$66.$$s, _slim_codeattributes17 = nil, _slim_codeattributes18 = nil;
    ...
    $def(self, '$convert_outline', function $$convert_outline(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$67(){var self = $$67.$$s == null ? this : $$67.$$s, _buf = nil, toclevels = nil, $ret_or_1 = nil, slevel = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1375]), opts)
        };
        _buf = [];
        if (!$truthy(self.$sections()['$empty?']())) {
          ...
          _buf['$<<'](slevel);
          _buf['$<<']("\">");
          $send(self.$sections(), 'each', [], function $$68(sec){var self = $$68.$$s == null ? this : $$68.$$s, child_toc = nil;
    ...
    $def(self, '$convert_inline_anchor', function $$convert_inline_anchor(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$69(){var self = $$69.$$s == null ? this : $$69.$$s, _buf = nil, refid = nil, $ret_or_2 = nil, _slim_controls1 = nil, _slim_controls3 = nil;
        if (self.type == null) self.type = nil;
        ...
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1392]), opts)
        };
        _buf = [];
        ...
        switch (self.type) {
          case "xref":
            ...
            _slim_controls1 = $send(self, 'html_tag', ["a", $hash2(["href", "class"], {"href": self.target, "class": [self.$role(), (($truthy(self['$option?']("step")) || ($truthy(self['$attr?']("step")))) ? ("fragment") : nil)].$compact()}).$merge(self.$data_attrs(self.attributes))], function $$70(){var self = $$70.$$s == null ? this : $$70.$$s, _slim_controls2 = nil;
              if (self.text == null) self.text = nil;
              if (self.document == null) self.document = nil;
    ...
    $def(self, '$convert_stem', function $$convert_stem(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$72(){var $a, $b, self = $$72.$$s == null ? this : $$72.$$s, _buf = nil, open = nil, close = nil, equation = nil, _slim_controls1 = nil;
        if (self.style == null) self.style = nil;
        ...
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1413]), opts)
        };
        _buf = [];
        ...
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["stemblock", self.$role(), ((($truthy(self['$option?']("step")) || ($truthy(self['$has_role?']("step")))) || ($truthy(self['$attr?']("step")))) ? ("fragment") : nil)]}).$merge(self.$data_attrs(self.attributes))], function $$73(){var self = $$73.$$s == null ? this : $$73.$$s, _slim_controls2 = nil;
    ...
    $def(self, '$convert_ulist', function $$convert_ulist(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$74(){var self = $$74.$$s == null ? this : $$74.$$s, _buf = nil, checklist = nil, marker_checked = nil, marker_unchecked = nil, _slim_controls1 = nil;
        if (self.document == null) self.document = nil;
        if (self.id == null) self.id = nil;
        if (self.style == null) self.style = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1431]), opts)
        };
        _buf = [];
        ...
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["ulist", checklist, self.style, self.$role()]}).$merge(self.$data_attrs(self.attributes))], function $$75(){var self = $$75.$$s == null ? this : $$75.$$s, _slim_controls2 = nil, _temple_html_attributeremover1 = nil, _slim_codeattributes1 = nil, $ret_or_1 = nil;
          if (self.style == null) self.style = nil;
          ...
          _slim_controls2['$<<'](">");
          $send(self.$items(), 'each', [], function $$76(item){var self = $$76.$$s == null ? this : $$76.$$s, _temple_html_attributeremover2 = nil, _slim_codeattributes2 = nil;
    ...
    $def(self, '$convert_inline_break', function $$convert_inline_break(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$77(){var self = $$77.$$s == null ? this : $$77.$$s, _buf = nil;
        if (self.text == null) self.text = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1464]), opts)
        };
        _buf = [];
        _buf['$<<'](self.text);
        _buf['$<<']("<br>");
    ...
    $def(self, '$convert_inline_kbd', function $$convert_inline_kbd(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$78(){var self = $$78.$$s == null ? this : $$78.$$s, _buf = nil, keys = nil, _slim_controls1 = nil, _slim_controls3 = nil;
        if (self.attributes == null) self.attributes = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1474]), opts)
        };
        _buf = [];
        if ($eqeq((keys = self.$attr("keys")).$size(), 1)) {
          
          _slim_controls1 = $send(self, 'html_tag', ["kbd", self.$data_attrs(self.attributes)], function $$79(){var _slim_controls2 = nil;
          ...
          _slim_controls3 = $send(self, 'html_tag', ["span", $hash2(["class"], {"class": ["keyseq"]}).$merge(self.$data_attrs(self.attributes))], function $$80(){var _slim_controls4 = nil;

            
            _slim_controls4 = [];
            $send(keys, 'each_with_index', [], function $$81(key, idx){
    ...
    $def(self, '$convert_page_break', function $$convert_page_break(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$82(){var self = $$82.$$s == null ? this : $$82.$$s, _buf = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1491]), opts)
        };
        _buf = [];
    ...
    $def(self, '$convert_thematic_break', function $$convert_thematic_break(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$83(){var self = $$83.$$s == null ? this : $$83.$$s, _buf = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1500]), opts)
        };
        _buf = [];
        _buf['$<<']("<hr>");
        return (_buf = _buf.$join(""));}, {$$s: self});
    ...
    $def(self, '$convert_inline_callout', function $$convert_inline_callout(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$84(){var self = $$84.$$s == null ? this : $$84.$$s, _buf = nil, _slim_codeattributes1 = nil, _slim_codeattributes2 = nil, _slim_codeattributes3 = nil;
        if (self.document == null) self.document = nil;
        if (self.text == null) self.text = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1509]), opts)
        };
        _buf = [];
        if ($truthy(self.document['$attr?']("icons", "font"))) {
    ...
    $def(self, '$convert_ruler', function $$convert_ruler(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$85(){var self = $$85.$$s == null ? this : $$85.$$s, _buf = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1524]), opts)
        };
        _buf = [];
        _buf['$<<']("<hr>");
        return (_buf = _buf.$join(""));}, {$$s: self});
    ...
    $def(self, '$convert_image', function $$convert_image(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$86(){var self = $$86.$$s == null ? this : $$86.$$s, _buf = nil, inline_style = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.attributes == null) self.attributes = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1533]), opts)
        };
        _buf = [];
        if (!($eqeq(self.$attributes()['$[]'](1), "background") || ($eqeq(self.$attributes()['$[]'](1), "canvas")))) {
          ...
          _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class", "style"], {"id": self.id, "class": ["imageblock", self.$role(), (($truthy(self['$option?']("step")) || ($truthy(self['$attr?']("step")))) ? ("fragment") : nil)], "style": inline_style}).$merge(self.$data_attrs(self.attributes))], function $$87(){var self = $$87.$$s == null ? this : $$87.$$s, _slim_controls2 = nil;
    ...
    $def(self, '$convert_example', function $$convert_example(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$88(){var self = $$88.$$s == null ? this : $$88.$$s, _buf = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.attributes == null) self.attributes = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1547]), opts)
        };
        _buf = [];
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["exampleblock", self.$role(), (($truthy(self['$option?']("step")) || ($truthy(self['$attr?']("step")))) ? ("fragment") : nil)]}).$merge(self.$data_attrs(self.attributes))], function $$89(){var self = $$89.$$s == null ? this : $$89.$$s, _slim_controls2 = nil;
    ...
    $def(self, '$convert_toc', function $$convert_toc(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$90(){var self = $$90.$$s == null ? this : $$90.$$s, _buf = nil, _temple_html_attributeremover1 = nil, _slim_codeattributes1 = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1559]), opts)
        };
        _buf = [];
        _buf['$<<']("<div id=\"toc\"");
        _temple_html_attributeremover1 = [];
    ...
    $def(self, '$convert_open', function $$convert_open(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$91(){var self = $$91.$$s == null ? this : $$91.$$s, _buf = nil, _slim_controls1 = nil, _slim_controls3 = nil;
        if (self.style == null) self.style = nil;
        if (self.document == null) self.document = nil;
        ...
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1584]), opts)
        };
        _buf = [];
        if ($eqeq(self.style, "abstract")) {
          if (($eqeq(self.parent, self.document) && ($eqeq(self.document.$doctype(), "book")))) {
            ...
            _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["quoteblock", "abstract", self.$role(), (($truthy(self['$option?']("step")) || ($truthy(self['$attr?']("step")))) ? ("fragment") : nil)]}).$merge(self.$data_attrs(self.attributes))], function $$92(){var self = $$92.$$s == null ? this : $$92.$$s, _slim_controls2 = nil;
          ...
          _slim_controls3 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["openblock", ($neqeq(self.style, "open") ? (self.style) : (nil)), self.$role(), (($truthy(self['$option?']("step")) || ($truthy(self['$attr?']("step")))) ? ("fragment") : nil)]}).$merge(self.$data_attrs(self.attributes))], function $$93(){var self = $$93.$$s == null ? this : $$93.$$s, _slim_controls4 = nil;
    ...
    $def(self, '$convert_pass', function $$convert_pass(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$94(){var self = $$94.$$s == null ? this : $$94.$$s, _buf = nil;

        
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1611]), opts)
        };
        _buf = [];
        _buf['$<<'](self.$content());
        return (_buf = _buf.$join(""));}, {$$s: self});
    ...
    $def(self, '$convert_section', function $$convert_section(node, opts) {
      ...
      return $send(node, 'instance_eval', [], function $$95(){var $a, $b, self = $$95.$$s == null ? this : $$95.$$s, _buf = nil, titleless = nil, title = nil, hide_title = nil, $ret_or_1 = nil, $ret_or_2 = nil, vertical_slides = nil, data_background_image = nil, data_background_size = nil, data_background_repeat = nil, data_background_position = nil, data_background_transition = nil, section_images = nil, bg_image = nil, data_background_video = nil, data_background_color = nil, parent_section_with_vertical_slides = nil, _slim_htag_filter1 = nil;
        ...
        vertical_slides = $send(self, 'find_by', [$hash2(["context"], {"context": "section"})], function $$96(section){
        ...
        section_images = $send(self.$blocks(), 'map', [], function $$97(block){var ctx = nil;
          ...
          if ($eqeq((ctx = block.$context()), "image")) {
            ...
            return []
          } else if ($truthy(($ret_or_1 = $send(block, 'find_by', [$hash2(["context"], {"context": "image"})], function $$98(image){
        ...
        $send(self, 'content_for', ["footnotes"], function $$99(){var self = $$99.$$s == null ? this : $$99.$$s, slide_footnotes = nil;
          ...
          if ((($truthy(self.$document()['$footnotes?']()) && ($not(self.$parent()['$attr?']("nofootnotes")))) && ($not(slide_footnotes['$empty?']())))) {
            ...
            $send(slide_footnotes, 'each', [], function $$100(footnote){
        ...
        $send(self, 'content_for', ["section"], function $$101(){var self = $$101.$$s == null ? this : $$101.$$s, _slim_codeattributes1 = nil, _temple_html_attributeremover1 = nil, _slim_codeattributes2 = nil, _slim_codeattributes3 = nil, _slim_codeattributes4 = nil, _slim_codeattributes5 = nil, _slim_codeattributes6 = nil, _slim_codeattributes7 = nil, _slim_codeattributes8 = nil, _slim_codeattributes9 = nil, _slim_codeattributes10 = nil, _slim_codeattributes11 = nil, _slim_codeattributes12 = nil, _slim_codeattributes13 = nil, _slim_codeattributes14 = nil, _slim_codeattributes15 = nil, _slim_codeattributes16 = nil, _slim_codeattributes17 = nil, _slim_codeattributes18 = nil, _slim_codeattributes19 = nil, _slim_codeattributes20 = nil, _slim_codeattributes21 = nil, _slim_codeattributes22 = nil, _slim_codeattributes23 = nil, _slim_codeattributes24 = nil, _blocks = nil, _content = nil;
          ...
          if ($truthy(parent_section_with_vertical_slides)) {
            ...
            if (!$truthy((_blocks = $rb_minus(self.$blocks(), vertical_slides))['$empty?']())) {
              ...
              $send(_blocks, 'each', [], function $$102(block){
        ...
        if ($truthy(parent_section_with_vertical_slides)) {
          ...
          $send(vertical_slides, 'each', [], function $$103(subsection){
    ...
    $def(self, '$convert_inline_quoted', function $$convert_inline_quoted(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$104(){var $a, $b, self = $$104.$$s == null ? this : $$104.$$s, _buf = nil, quote_tags = nil, quote_tag = nil, open = nil, close = nil;
        if (self.type == null) self.type = nil;
        if (self.id == null) self.id = nil;
        if (self.attributes == null) self.attributes = nil;
        if (self.text == null) self.text = nil;
        ...
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1734]), opts)
        };
        _buf = [];
    ...
    $def(self, '$convert_dlist', function $$convert_dlist(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$105(){var self = $$105.$$s == null ? this : $$105.$$s, _buf = nil, _slim_controls1 = nil, _slim_controls3 = nil, _slim_controls5 = nil;
        if (self.style == null) self.style = nil;
        if (self.id == null) self.id = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1756]), opts)
        };
        _buf = [];
        ...
        switch (self.style) {
          case "qanda":
            ...
            _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["qlist", self.style, self.$role()]}).$merge(self.$data_attrs(self.attributes))], function $$106(){var self = $$106.$$s == null ? this : $$106.$$s, _slim_controls2 = nil;
              ...
              _slim_controls2['$<<']("<ol>");
              $send(self.$items(), 'each', [], function $$107(questions, answer){
                
                if (questions == null) questions = nil;
                if (answer == null) answer = nil;
                _slim_controls2['$<<']("<li>");
                $send([].concat($to_a(questions)), 'each', [], function $$108(question){
          ...
          case "horizontal":
            ...
            _slim_controls3 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["hdlist", self.$role()]}).$merge(self.$data_attrs(self.attributes))], function $$109(){var self = $$109.$$s == null ? this : $$109.$$s, _slim_controls4 = nil, _slim_codeattributes1 = nil, _slim_codeattributes2 = nil;
              ...
              $send(self.$items(), 'each', [], function $$110(terms, dd){var self = $$110.$$s == null ? this : $$110.$$s, _temple_html_attributeremover1 = nil, _slim_codeattributes3 = nil, last_term = nil;
                ...
                $send(terms, 'each', [], function $$111(dt){
          ...
          default:
            ...
            _slim_controls5 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["dlist", self.style, self.$role()]}).$merge(self.$data_attrs(self.attributes))], function $$112(){var self = $$112.$$s == null ? this : $$112.$$s, _slim_controls6 = nil;
              ...
              _slim_controls6['$<<']("<dl>");
              $send(self.$items(), 'each', [], function $$113(terms, dd){var self = $$113.$$s == null ? this : $$113.$$s;

                
                if (terms == null) terms = nil;
                if (dd == null) dd = nil;
                $send([].concat($to_a(terms)), 'each', [], function $$114(dt){var self = $$114.$$s == null ? this : $$114.$$s, _temple_html_attributeremover2 = nil, _slim_codeattributes4 = nil;
                  if (self.style == null) self.style = nil;
    ...
    $def(self, '$convert_audio', function $$convert_audio(node, opts) {
      ...
      if (opts == null) opts = $hash2([], {});
      node.$extend($$('Helpers'));
      return $send(node, 'instance_eval', [], function $$115(){var self = $$115.$$s == null ? this : $$115.$$s, _buf = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.style == null) self.style = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1817]), opts)
        };
        _buf = [];
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["audioblock", self.style, self.$role()]}).$merge(self.$data_attrs(self.attributes))], function $$116(){var self = $$116.$$s == null ? this : $$116.$$s, _slim_controls2 = nil, _slim_codeattributes1 = nil, _slim_codeattributes2 = nil, _slim_codeattributes3 = nil, _slim_codeattributes4 = nil;
    ...
    $def(self, '$convert_verse', function $$convert_verse(node, opts) {
      ...
      return $send(node, 'instance_eval', [], function $$117(){var self = $$117.$$s == null ? this : $$117.$$s, _buf = nil, _slim_controls1 = nil;
        ...
        if (!$truthy(opts['$empty?']())) {
          self.$converter().$set_local_variables(Opal.Binding.$new(  function($code) {    return eval($code);  },  ["node", "opts"],  self,  ['asciidoctor-revealjs/converter.rb', 1831]), opts)
        };
        _buf = [];
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["verseblock", self.$role(), (($truthy(self['$option?']("step")) || ($truthy(self['$attr?']("step")))) ? ("fragment") : nil)]}).$merge(self.$data_attrs(self.attributes))], function $$118(){var self = $$118.$$s == null ? this : $$118.$$s, _slim_controls2 = nil, attribution = nil, citetitle = nil;
...
Opal.modules["asciidoctor-revealjs/version"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  return (function($base, $parent_nesting) {
    ...
    return (function($base, $parent_nesting) {
      ...
      return $const_set($nesting[0], 'VERSION', "5.2.0")
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
